  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Evaluación de términos en metodologías de desarrollo de #[em software]
        p.mb-4 Asociar conceptos clave con sus descripciones correspondientes para reforzar el conocimiento de las metodologías de desarrollo de #[em software].
